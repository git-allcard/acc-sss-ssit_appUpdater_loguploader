        ...
        Try
            ...
            For n = LBound(logFiles) To UBound(logFiles)
                If firstRun = 1 Then
                    ...
                    Dim lUPdated As String = db.putSingleValue(" select max(ENCODE_DT) from  SSTRANSAT  where BRANCH_IP= '" & terminalIP & "' ")
                    ...
                    For r = 0 To daysOff - 1
                        ...
                        If Not Date.Now <= CDate(dateStr) Then
                            ...
                            strFilename = "D:\SSIT\logs\" & prevDate1 & " " & kioskBranch & "\" & logFiles(n) & ".txt" '"\transaction_logs.txt"
                            copyFile = "D:\SSIT\logs\" & prevDate1 & " " & kioskBranch & "\" & logFiles(n) & "1.txt" '"\transaction_logs1.txt"
                ...
                Else
                    ...
                    strFilename = "D:\SSIT\logs\" & prevDate & " " & kioskBranch & "\" & logFiles(n) & ".txt" '"\transaction_logs.txt"
                    copyFile = "D:\SSIT\logs\" & prevDate & " " & kioskBranch & "\" & logFiles(n) & "1.txt"   ' "\transaction_logs1.txt"
