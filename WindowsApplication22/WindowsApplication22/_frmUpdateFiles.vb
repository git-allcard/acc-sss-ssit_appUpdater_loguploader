...
Public Class _frmUpdateFile
            ...
            For Each item As ListViewItem In listview1.Items
                ...
                If updateTag = 1 Then
                    ...
                    If Cnt1 = "" Or Cnt1 = Nothing Then
                        ...
                        xs.backUpSettings()
                        xs.editSettings(xs.xml_Filename, xs.value_path, "downloadedPath", Class1.appRepo & "\SSIT_SERVER\")
                        xs.backUpSettings()
                    ...
                    Else
                        ...
                        If CDate(lastUpdated) < CDate(item.SubItems.Item(1).Text) Then
                            ...
                            'My.Settings.downloadedPath = Class1.appRepo & "\SSIT_SERVER\" 'C:\Program Files\SSIT
                ...
                ElseIf updateTag = 2 Then
                    ...
                    Dim vidPath As String = Class1.appRepo & "\SSIT_SERVER\Video"
                ...
                ElseIf updateTag = 3 Then
                    ...
                    If Cnt1 = "" Or Cnt1 = Nothing Then
                        ...
                        xs.backUpSettings()
                        xs.editSettings(xs.xml_Filename, xs.value_path, "downloadedPath", Class1.appRepo & "\")
                        xs.backUpSettings()
                        ...
                        'My.Settings.downloadedPath = Class1.appRepo & "" 'C:\C:\Users\NCJALUAG\Desktop\JEan\08022014\NIKKI ETO NA\WindowsApplication22\WindowsApplication22\Connection\Program Files\SSIT
                    ...
                    Else
                        ...
                        If CDate(lastUpdated) < CDate(item.SubItems.Item(1).Text) Then
                            ...
                            ' My.Settings.Reload()
                            'My.Settings.SSIT_Path = "SSIT_SERVER\SSIT_SERVER.exe"  ' SSIT_SERVER/SSIT_SERVER.exe
                            'My.Settings.downloadedPath = Class1.appRepo & "" 'C:\Program Files\SSIT
                            'My.Settings.ftp_Path = "Application/SSIT_SERVER.exe"  'Application/SSIT_SERVER.exe
                ...
                ElseIf updateTag = 5 Then
                    ...
                    If Cnt1 = "" Or Cnt1 = Nothing Then
                        ...
                        xs.backUpSettings()
                        xs.editSettings(xs.xml_Filename, xs.value_path, "SSIT_Path", "terms_and_conditions\terms_and_conditions.pdf")
                        xs.backUpSettings()
                        xs.editSettings(xs.xml_Filename, xs.value_path, "downloadedPath", Class1.appRepo & "\SSIT_SERVER\")
                        xs.backUpSettings()
                        xs.editSettings(xs.xml_Filename, xs.value_path, "ftp_Path", "Terms/terms_and_conditions.pdf")
                        xs.backUpSettings()
    ...
    Private Function ReturnRemoteFileSize(ByVal uri As Uri,
    ...
    Public Shared Sub OpenOldSSSDecrypt()
        Dim strFile As String = Class1.appRepo & "\SSIT_SERVER\sss card\old_sss_decrypt.exe"
