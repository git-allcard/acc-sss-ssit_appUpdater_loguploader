...
Public Class _frmSendLogs
    ...
    Private Sub sendLogs()
        Try
            ...
            Dim time_sent As String = db.putSingleValue("Select CAST([Time] As VARCHAR) from SSINFOTERMDBSETTINGS where tag = '1' and type = 'SQL'")
            ' MsgBox(time_sent)
    ...
    Private Sub _frmSendLogs_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ' System.Diagnostics.Process.Start(Class1.appRepo & "\SSIT_SERVER\SSIT_SERVER.exe")
        'System.Diagnostics.Process.Start(Class1.appRepo & "\SSIT Application Checker\checker.exe")
        Try
